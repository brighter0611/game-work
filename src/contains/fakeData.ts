...
import avatar8 from "@/images/avatars/Image-30.png";
import avatar9 from "@/images/avatars/Image-9.png";
import avatar10 from "@/images/avatars/Image-10.png";
//
import product1 from "@/images/landingpage-products/Dragon_s Dogma 2 PC Steam Offline Deluxe Edition.jpg";
import product2 from "@/images/landingpage-products/EA Sports FC 24 PC Steam Offline EA App.jpg";
import product3 from "@/images/landingpage-products/Elden Ring Pc Steam Offline - Modo Campanha - Shadow of the Erdtree Premium Bundle.jpg";
import product4 from "@/images/landingpage-products/F1 24 Steam Offline Champions Edition (1).jpg";
import product5 from "@/images/landingpage-products/Football Manager 2024 Pc Steam Offline + Editor In-Game + Brasil Mundi Up.jpg";
import product6 from "@/images/landingpage-products/Forza Horizon 5 Edição Suprema PC Microsoft OnlineOffline.jpg";
import product7 from "@/images/landingpage-products/GTA 5 Premium Edition PC Steam Offline.jpg";
import product8 from "@/images/landingpage-products/Ghost of Tsushima DIRECTOR_S CUT Steam Offline.jpg";
import product9 from "@/images/landingpage-products/God Of War Pc Steam Offline - Modo Campanha.jpg";
import product10 from "@/images/landingpage-products/Pes 21 PC Steam Offline - eFootball Pes 2021 PC.jpg";
import product11 from "@/images/landingpage-products/Red Dead Redempton 2 Ultimate Edition PC Steam Offline - Modo Campanha.jpg";
import product12 from "@/images/landingpage-products/Resident Evil 4 Remake Deluxe Edition Pc Steam Offline + DLC Separate Ways.jpg";
import product13 from "@/images/landingpage-products/Dragon_s Dogma 2 PC Steam Offline Deluxe Edition.jpg";
import product14 from "@/images/landingpage-products/EA Sports FC 24 PC Steam Offline EA App.jpg";
import product15 from "@/images/landingpage-products/Elden Ring Pc Steam Offline - Modo Campanha - Shadow of the Erdtree Premium Bundle.jpg";
import product16 from "@/images/landingpage-products/F1 24 Steam Offline Champions Edition (1).jpg";
import product17 from "@/images/landingpage-products/Football Manager 2024 Pc Steam Offline + Editor In-Game + Brasil Mundi Up.jpg";
import product18 from "@/images/landingpage-products/Forza Horizon 5 Edição Suprema PC Microsoft OnlineOffline.jpg";
import product19 from "@/images/landingpage-products/GTA 5 Premium Edition PC Steam Offline.jpg";
import product20 from "@/images/landingpage-products/Ghost of Tsushima DIRECTOR_S CUT Steam Offline.jpg";
import product21 from "@/images/landingpage-products/God Of War Pc Steam Offline - Modo Campanha.jpg";
import product22 from "@/images/landingpage-products/Pes 21 PC Steam Offline - eFootball Pes 2021 PC.jpg";
import product23 from "@/images/landingpage-products/Red Dead Redempton 2 Ultimate Edition PC Steam Offline - Modo Campanha.jpg";
import product24 from "@/images/landingpage-products/Resident Evil 4 Remake Deluxe Edition Pc Steam Offline + DLC Separate Ways.jpg";
//
