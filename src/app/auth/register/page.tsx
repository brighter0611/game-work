  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try{
      ...
      if (data && data.success) {
        ...
        setLoding(false);
        toast.error(data ? data.message : "An error occurred during registration.");
      }
    } catch {
      setLoding(false);
  ...
  return (
    ...
    <div className='w-full h-screen'>
      <div className="flex flex-col text-center items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0 shadow-xl">
        ...
        <div className="w-full bg-slate-400 rounded-lg shadow text-black md:mt-0 sm:max-w-md xl:p-0 ">
