    ...
    <>
      <section className="text-center">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0">
          <div className="w-full p-6 bg-slate-400 rounded-lg shadow  md:mt-0 sm:max-w-md  sm:p-8">
            ...
            <p className="text-sm text-black ">
                ...
                <Link href={"/auth/login"} className="font-medium text-orange-600 hover:underline ">Sign up</Link>
            </p>
          </div>
        </div>
        <ToastContainer />
